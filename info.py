...
PICS = (environ.get('PICS', 'https://ibb.co/FkzhHFMB https://ibb.co/L3DDzVk')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6703898477').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002212552344'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003099906184'))  # Bin channel id (make sure bot is admin)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002212552344'))  # Premium logs channel id
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+oysDrXB04xgyZDZl')  # Tutorial video link for opening shortlink website
