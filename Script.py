class script(object):
    START_TXT = """<b> 🚩 ಜೈ ಶ್ರೀ ರಾಮ್\n\n ʜᴇʏ {}, {}\n\n𝒊 𝑨𝒎 𝑻𝒉𝒆 𝑴𝒐𝒔𝒕 𝑷𝒐𝒘𝒆𝒓𝒇𝒖𝒍 𝑨𝒖𝒕𝒐 𝑭𝒊𝒍𝒕𝒆𝒓 𝑩𝒐𝒕.\n<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/Kannada_Cinema_World">KannadaCinemaWorld</a></blockquote></b>"""

    GSTART_TXT = """<b>🚩 ಜೈ ಶ್ರೀ ರಾಮ್\n\nʜᴇʏ {},\n\n𝒊 𝑨𝒎 𝑻𝒉𝒆 𝑴𝒐𝒔𝒕 𝑷𝒐𝒘𝒆𝒓𝒇𝒖𝒍 𝑨𝒖𝒕𝒐 𝑭𝒊𝒍𝒕𝒆𝒓 𝑩𝒐𝒕.</b>"""
    
    HELP_TXT = """<b>🚩 ಜೈ ಶ್ರೀರಾಮ್🚩\n\nʜᴇʏ {},
    
<b>🎬 ಸಿನಿಮಾ ಹುಡುಕಲು, ಚಿತ್ರದ ಹೆಸರನ್ನು ಸರಿಯಾಗಿ ಟೈಪ್ ಮಾಡಿ ಗ್ರೂಪ್‌ನಲ್ಲಿ ಕಳುಹಿಸಿ.</b>
...
🚫 <b>ಹೀಗೆ ಬರೆಯಬೇಡಿ:</b>  
❌ Kantara movie link pls bro  
❌ Send Kantara movie  

🤖 <b>ಬಾಟ್ ನಿಮ್ಮ ಕೇಳಿದ ಸಿನಿಮಾವನ್ನು ಹುಡುಕಿ ದೊರೆತರೆ ತಕ್ಷಣ ಕಳುಹಿಸುತ್ತದೆ.</b>
</b>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/Kannada_Cinema_World">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a https://t.me/Kannada_Cinema_World>[Dreamcine_Botz]</a></b>"""
...
‼️ 𝑨𝒇𝒕𝒆𝒓 𝑺𝒆𝒏𝒅𝒊𝒏𝒈 𝑨 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝑷𝒍𝒆𝒂𝒔𝒆 𝑮𝒊𝒗𝒆 𝒖𝒔 𝒔𝒐𝒎𝒆 𝑻𝒊𝒎𝒆 𝑻𝒐 𝑨𝒅𝒅 𝒀𝒐𝒖 𝑰𝒏 𝑻𝒉𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑳𝒊𝒔𝒕.</b>"""    
 ...
 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ʜᴇʀᴇ ◉› :<a href=https://t.me/Kannada_Cinema_World>KannadaCinemaWorld</a>\n """
